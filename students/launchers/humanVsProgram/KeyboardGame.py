...
####################################################################################################################################################################################################################################
#                                                                                                                 #                                                                                                                #
#    This script starts 2 players match in which the first token is controlled by the keyboard                    #    Ce script démarre une partie à 2 joueurs dans laquelle le premier jeton est contrôlé par le clavier         #
#    Command line: {thisScript} <player2FileName>                                                                 #    Ligne de commande : {thisScript} <player2FileName>                                                          #
#                                                                                                                 #                                                                                                                #
####################################################################################################################################################################################################################################
#                                                                                                                 #                                                                                                                #
...
#    --------------------------                                                                                   #    --------------------------                                                                                  #
#                                                                                                                 #                                                                                                                #
#        Path to the opponent AI file                                                                             #        Chemin vers le fichier d'AI à affronter au clavier                                                      #
...
if len(sys.argv) != 2 :
    print("[ERROR] Wrong arguments count (usage: " + sys.argv[0] + " <player2FileName>)")
    exit()
PLAYER_2_FILE_NAME = sys.argv[1]
...
#                                                                                                                 #                                                                                                                #
#    PLAYER_FILE_NAME : string                                                                                    #    PLAYER_FILE_NAME : string                                                                                   #
#    -------------------------                                                                                    #    -------------------------                                                                                   #
#                                                                                                                 #                                                                                                                #
#        Path to the file corresponding to the keyboard player                                                    #        Chemin du fichier correspondant à un joueur au clavier                                                  #
#                                                                                                                 #                                                                                                                #
####################################################################################################################################################################################################################################
...
KEYBOARD_FILE_NAME = "./programs/Keyboard.py"
...
# We start the game
gameInfo = LaunchersLibrary.startRandomGame(MAZE_WIDTH, MAZE_HEIGHT, MAZE_DENSITY, MUD_PROBABILITY, MAZE_SYMMETRIC, NB_PIECES_OF_CHEESE, TIMING_INFORMATION, SHOW_GUI_AND_SHELLS, OUTPUT_DIRECTORY, TIMEOUT, KEYBOARD_FILE_NAME, PLAYER_2_FILE_NAME)
