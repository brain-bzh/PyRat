...
#    A single piece of cheese is placed at the center of the maze                                                 #    Un unique morceau de fromage est placé au centre du labyrinthe                                              #
...
# We start the game
gameInfo = LaunchersLibrary.startRandomGame(MAZE_WIDTH, MAZE_HEIGHT, MAZE_DENSITY, MUD_PROBABILITY, MAZE_SYMMETRIC, NB_PIECES_OF_CHEESE, TIMING_INFORMATION, SHOW_GUI_AND_SHELLS, OUTPUT_DIRECTORY, TIMEOUT, PLAYER_FILE_NAME)
