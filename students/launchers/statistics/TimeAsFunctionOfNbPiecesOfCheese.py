...
####################################################################################################################################################################################################################################
#                                                                                                                 #                                                                                                                #
#    This script studies the mean computation time as a function of the number of pieces of cheese                #    Ce script étudie le temps de calcul moyen en fonction du nombre de fromages                                 #
    ...
    for fileName in PLAYERS_FILE_NAMES :
        ...
        for test in range(NB_TESTS) :
            ...
            if gameInfo == {} :
                ...
                exit()
            meanResults += (gameInfo["player1"]["preprocessingComputationTime"] + gameInfo["player1"]["turnsComputationTime"]) / NB_TESTS
...
matplotlib.pyplot.ylabel("Mean computation time")
